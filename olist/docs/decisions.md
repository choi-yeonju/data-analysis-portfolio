...
- delivered인데 도착일 없는 8건(전체 기간): 도착일 필터로 제외. 분석기간 내 건수는 Day 3에서 확정
...
- D-05 멀티셀러 주문에서 대표 아이템 기준(가격 vs 거리) 일치율 확인. 계산 대상은 분석 모집단(96,204건) 기준 멀티셀러 1,272건(1.32%). order_items 전체 기준은 1,278건(1.3%)
